...
namespace workshopsAPI.Migrations
{
    ...
    [Migration("20250115060601_Added session model with updted seed data")]
    partial class Addedsessionmodelwithupdtedseeddata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("workshopsAPI.Models.Domain.Session", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("workshopsAPI.Models.Domain.Session", b =>
                {
                    b.HasOne("workshopAPI.Models.Domain.Workshop", "Workshop")
                        .WithMany("Sessions")
